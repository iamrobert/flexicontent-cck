...
<?php endif;?>
	...
	<thead>
		<tr>
			...
			<th class="col_lang hideOnDemandClass center hidden-phone" style="<?php echo $this->hideCol($colposition++); ?>" >
		...
		<?php endforeach; ?>
			...
			<th class="col_created hideOnDemandClass right hidden-phone" style="<?php echo $this->hideCol($colposition++); ?>" >
    ...
    <?php foreach($this->extra_fields as $field) :?>
		...
		<?php endforeach; ?>
			...
			<td class="col_revised small right hidden-phone hidden-tablet" style="<?php echo $this->hideCol($colposition++); ?>" >
